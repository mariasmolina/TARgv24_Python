...
# try:
#     temp=float(input("Mis temperatuur täna on?(kraadid) "))
#     if temp>18:
#         print(f"Soovitav toasoojus talvel on {temp} kraadid")
#     else:
#         print("Liiga külm!")
# except:
#     print("Vale andmetüüp!")
...
# if vastus1=="JAH" or vastus2=="JAH" or vastus3=="JAH":
#     print("Ostutšekk")
#     if vastus1=="JAH":
...
# if vastus1=="EI" and vastus2=="EI" and vastus3=="EI":
...
# #Ülesanne 11 - Juubel
# sünnipäev=input("Sisetage oma sünnipäev")
...
#     soodus2=hind*0.8
#     if hind<=10:
#         print(f"Teile tuleb soodus 10%! Toote lõplik hind on {round(soodus1,2)}")
#     else:
#         print(f"Teile tuleb soodus 20%! Toote lõplik hind on {round(soodus2,2)}")
# except:
#     print("Vale andmetüüp!")
# print()
