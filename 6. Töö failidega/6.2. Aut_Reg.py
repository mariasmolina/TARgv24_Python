...
salasõnad=loe_failist("6. Töö failidega/Salasõnad.txt")
kasutajanimed=loe_failist("6. Töö failidega/Kasutajad.txt")
while True:
    print(kasutajanimed)
    print(salasõnad)
    ...
    if vastus==1:
        ...
        kirjuta_failisse('6. Töö failidega/Kasutajad.txt',kasutajanimed)
        kirjuta_failisse('6. Töö failidega/Salasõnad.txt',salasõnad)
    elif vastus==2:
        ...
        if vastus=="nimi":
            ...
            kasutajanime=ümber_kirjuta_fail('6. Töö failidega/Kasutajad.txt')
        elif vastus=="parool":
            salasõnad=nimi_või_parooli_muurmine(salasõnad)
            salasõnad=ümber_kirjuta_fail('6. Töö failidega/Salasõnad.txt')
        elif vastus=="mõlemad":
            print("Nimi muutmine: ")
            kasutajanimed=nimi_või_parooli_muurmine(kasutajanimed)
            kasutajanime=ümber_kirjuta_fail('6. Töö failidega/Kasutajad.txt')
